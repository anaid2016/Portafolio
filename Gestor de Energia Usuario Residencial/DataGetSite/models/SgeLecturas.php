...
class SgeLecturas extends \yii\db\ActiveRecord
{
    ...
    public function getMedidor()
    {
     ...
     public function getConcentrador($medidor_id)
    {
         
       $concentrador = SgeConcentradores::find()
                 ->leftJoin('sge_circuitos', 'sge_concentradores.concentrador_id = sge_circuitos.concentrador_id')
                 ->leftJoin('sge_medidores', 'sge_circuitos.circuitos_id = sge_medidores.circuito_id')
                 ->where(['sge_medidores.medidor_id'=>$medidor_id])
                 ->one();
        
         return $concentrador->alias_concentrador;
    }
}
