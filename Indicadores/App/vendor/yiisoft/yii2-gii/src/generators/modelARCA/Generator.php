...
namespace yii\gii\generators\modelARCA;
...
class Generator extends \yii\gii\Generator
{
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            'ns' => 'Este es el namespace de la clase ActiveRecord que se va a generar, e.g., <code>app\models</code>',
    ...
    public function requiredTemplates()
    {
        ...
        return ['entidadmodel.php'/*, 'query.php'*/];
    }
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $this->baseClassPry =   $this->baseClassPry;
            ...
            $right_length = (strlen(strstr($this->ns, '\\')) - 1); 
            $left_length = ($whole_length - $right_length - 1); 
            $start = (0 - ($right_length + 1)); 
            $this->nsa=substr($this->ns, 0, ($left_length + 1)).'tests\unit\\'.''.substr($this->ns, $start+1); 
