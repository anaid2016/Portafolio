...
/**
 * GlosarioControllerFachadaTest implementa la verificaicon de los valores, consulta información para aplicar reglas de negocio, y transacciones conforme las acciones para el modelo Glosario.
 */
class GlosarioControllerFachadaTest extends \Codeception\Test\Unit
{
...
/**para mayor informacion sobre asserts => http://codeception.com/docs/modules/Asserts y http://codeception.com/10-04-2013/specification-phpunit.html**/
    ...
    public function testBehaviors()
    {
        ...
        $tester = new  GlosarioControllerFachada();
        // se valida que se cree la instancia exitosamente
        $this->assertTrue($tester!=null);
        $this->assertInstanceOf('app\controllers\indicadores\GlosarioControllerFachada', $tester);
    ...
    public function testActionCreate()
    {
        ...
        $this->assertInstanceOf('app\controllers\indicadores\GlosarioControllerFachada', $tester);
            ...
            // Se declaran el rquest
              $request =  ['GlosarioControllerFachada' => [
                                'cod_glosario' => 'Ingresar valor de pruebas para el campo cod_glosario de tipo int4',
                             'nombre' => 'Ingresar valor de pruebas para el campo nombre de tipo varchar',
                             'descripcion' => 'Ingresar valor de pruebas para el campo descripcion de tipo varchar',
                          ]];
