...
/**
 * IndicadorParametroSearch representa el modelo detras del formulario de busqueda para `app\models\gisindicadores\IndicadorParametro`.
 */
class IndicadorParametroSearch extends IndicadorParametro
{
    /**
     * {@inheritdoc}
     */
