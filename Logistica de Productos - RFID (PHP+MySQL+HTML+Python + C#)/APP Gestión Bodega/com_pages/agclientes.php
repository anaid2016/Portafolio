...
<!--Menu de Solapas -->
	<div id="tabsI">
    	 <ul>
            ...
            <li><a href="<?php echo (!empty($_GET['Id']))? 'dirclientes.php?Id='.$_GET['Id']:'' ?>" title="Direcciones"><span>Direcciones</span></a></li>
         </ul>
    </div>
...
<div id="contenidof">
    ...
    <?php
            ...
            if(!empty($_POST['Guardar']) && empty($_GET['Id'])){
				...
				if($id==''){
					$insertar=mysql_query("INSERT INTO com_clientes SET nombres='$v1',nit='$v2',regimen='$v3',representantelegal='$v4',documento='$v5',celular='$v6',correo='$v7' ",$conexion);
					$id=mysql_insert_id();
				}else{
					$insertar=mysql_query("UPDATE com_clientes SET nombres='$v1',nit='$v2',regimen='$v3',representantelegal='$v4',documento='$v5',celular='$v6',correo='$v7' WHERE Id='$id'",$conexion);
				}
				if(mysql_errno($conexion)==0){
                        echo "<p>Cliente creado con exito</p>";
                }else{
                    if(mysql_errno($conexion)==1062){
                        echo "<p>El cliente ya existe en el sistema.</p>";
                        die();
                    }else{
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
               ...
               <h3>Datos Generales de Cliente</h3>
                   <!--Formulario 1-->
                      <table>
                         <tr>
                                <td>Razón Social:</td>
                      ...
                      <h3>Datos del Representante Legal</h3>
                        ...
                        <p align="center">
                          <input type="submit" name="Guardar" id="Registrar Cliente" value="Registrar Cliente">
                        </p>
                        </form>
    <?php
			}
