...
function suavexpsimple($yearmenor,$year,$mesactual2,$mesactual,$intro0,$vinformacion,$alfa){
	 ...
	 for($b=$yearmenor;$b<=$year;$b++){
		...
		$ini=($b==$yearmenor)? $mesactual2:1;
		$fin=($b==$year)? $mesactual:12;
...
function suavhotltende($yearmenor,$year,$mesactual2,$mesactual,$intro0,$vinformacion,$alfa,$beta){
	 $daysprom=0;
	 $xnew=array();
	 $pronosticos=1;
	 $error=0;
...
function suavhotlwintmultiplicativo($yearmenor,$year,$mesactual2,$mesactual,$intro0,$vinformacion,$alfa,$beta,$gama){
...
function suavhotlwintaditivo($yearmenor,$year,$mesactual2,$mesactual,$intro0,$vinformacion,$alfa,$beta,$gama){
