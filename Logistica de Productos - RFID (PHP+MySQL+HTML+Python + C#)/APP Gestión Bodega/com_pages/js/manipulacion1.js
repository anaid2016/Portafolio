$(document).ready(function(){
	...
	$(document).on('click','.clsAgregarFila',function(){
		...
		var strNueva_Fila='<tr>'+
			'<td><select name="a'+real+'" id="a'+real+'"></select></td>'+
			'<td><input type="text" class="clsAnchoTotal" name="b'+real+'" ></td>'+
			'<td><input type="text" class="clsAnchoTotal" name="c'+real+'" onblur="PrecioFinal(this,'+real+')"></td>'+
			'<td><input type="text" class="clsAnchoTotal" name="e'+real+'" id="valorfinal'+real+'"></td>'+
