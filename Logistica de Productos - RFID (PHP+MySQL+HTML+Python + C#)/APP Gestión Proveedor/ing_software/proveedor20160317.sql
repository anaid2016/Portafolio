...
INSERT INTO `prov_categorias` VALUES ('5', 'Caña', 'Ca');
...
INSERT INTO `prov_color` VALUES ('14', 'Vino Tinto', 'VT');
...
INSERT INTO `prov_movimientoproducto` VALUES ('65', '8', '2', '1', '19', '2016-03-10', '11', '1200.00', '2016-03-15', '5', '2');
...
INSERT INTO `prov_movimientoproducto` VALUES ('83', '8', '2', '1', '37', '2016-03-10', '11', '1200.00', '2016-03-15', '5', '2');
...
INSERT INTO `prov_movimientoproducto` VALUES ('138', '8', '2', '1', '80', '2016-03-15', '11', '1200.00', '2016-03-15', '5', '1');
INSERT INTO `prov_movimientoproducto` VALUES ('139', '8', '2', '1', '81', '2016-03-15', '11', '1200.00', '2016-03-15', '5', '1');
INSERT INTO `prov_movimientoproducto` VALUES ('140', '8', '2', '1', '82', '2016-03-15', '11', '1200.00', '2016-03-15', '5', '1');
INSERT INTO `prov_movimientoproducto` VALUES ('141', '8', '2', '1', '83', '2016-03-15', '11', '1200.00', '2016-03-15', '5', '1');
INSERT INTO `prov_movimientoproducto` VALUES ('142', '8', '2', '1', '84', '2016-03-15', '11', '1200.00', '2016-03-15', '5', '1');
INSERT INTO `prov_movimientoproducto` VALUES ('143', '8', '2', '1', '85', '2016-03-15', '11', '1200.00', '2016-03-15', '5', '1');
INSERT INTO `prov_movimientoproducto` VALUES ('144', '8', '2', '1', '86', '2016-03-15', '11', '1200.00', '2016-03-15', '5', '1');
INSERT INTO `prov_movimientoproducto` VALUES ('145', '8', '2', '1', '87', '2016-03-15', '11', '1200.00', '2016-03-15', '5', '1');
INSERT INTO `prov_movimientoproducto` VALUES ('146', '8', '2', '1', '88', '2016-03-15', '11', '1200.00', '2016-03-15', '5', '1');
INSERT INTO `prov_movimientoproducto` VALUES ('147', '8', '2', '1', '89', '2016-03-15', '11', '1200.00', '2016-03-15', '5', '1');
INSERT INTO `prov_movimientoproducto` VALUES ('148', '8', '2', '1', '90', '2016-03-15', '11', '1200.00', '2016-03-15', '5', '1');
INSERT INTO `prov_movimientoproducto` VALUES ('149', '8', '2', '1', '91', '2016-03-15', '11', '1200.00', '2016-03-15', '5', '1');
...
INSERT INTO `prov_nombres` VALUES ('19', 'Cualquiera', 'CA');
...
INSERT INTO `prov_ordenventa` VALUES ('11', 'OV007', '2016-03-15', '3', '1', '16800.00', '2016-03-15');
...
INSERT INTO `prov_producto` VALUES ('20', '2', '2', '1', '12000.00', '10000.00', 'CTVA40', '1', '4', '19');
...
INSERT INTO `prov_productosorden` VALUES ('109', '11', '65', '1', '3', '1200.00');
INSERT INTO `prov_productosorden` VALUES ('110', '11', '83', '1', '3', '1200.00');
INSERT INTO `prov_productosorden` VALUES ('111', '11', '138', '1', '3', '1200.00');
INSERT INTO `prov_productosorden` VALUES ('112', '11', '139', '1', '3', '1200.00');
INSERT INTO `prov_productosorden` VALUES ('113', '11', '140', '1', '3', '1200.00');
INSERT INTO `prov_productosorden` VALUES ('114', '11', '143', '1', '3', '1200.00');
INSERT INTO `prov_productosorden` VALUES ('115', '11', '144', '1', '3', '1200.00');
INSERT INTO `prov_productosorden` VALUES ('116', '11', '145', '1', '3', '1200.00');
INSERT INTO `prov_productosorden` VALUES ('117', '11', '146', '1', '3', '1200.00');
INSERT INTO `prov_productosorden` VALUES ('118', '11', '147', '1', '3', '1200.00');
INSERT INTO `prov_productosorden` VALUES ('119', '11', '148', '1', '3', '1200.00');
INSERT INTO `prov_productosorden` VALUES ('120', '11', '149', '1', '3', '1200.00');
INSERT INTO `prov_productosorden` VALUES ('121', '11', '141', '1', '3', '1200.00');
INSERT INTO `prov_productosorden` VALUES ('122', '11', '142', '1', '3', '1200.00');
...
INSERT INTO `prov_productosorden2` VALUES ('31', '11', '8', '8', '2', '26', 'CMHN39');
...
INSERT INTO `prov_productosorden2` VALUES ('40', '11', '8', '14', '2', '35', 'CMHN39');
INSERT INTO `prov_productosorden2` VALUES ('41', null, '2', '5', '1', '36', 'CMHM39');
INSERT INTO `prov_productosorden2` VALUES ('42', null, '19', '7', '1', '37', 'CTVG40');
INSERT INTO `prov_productosorden2` VALUES ('43', null, '16', '8', '1', '38', 'CMHA40');
...
CREATE TABLE `prov_tallas` (
  ...
  PRIMARY KEY (`Id`),
  UNIQUE KEY `talla` (`talla`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=latin1;
...
INSERT INTO `prov_tallas` VALUES ('20', '41');
...
INSERT INTO `prov_tipo` VALUES ('10', 'Tennis Plataforma', 'TP');
...
INSERT INTO punto_venta.pv_categorias SET Id=NEW.Id,nombre=NEW.nombre,referencia=NEW.referencia;
...
UPDATE punto_venta.pv_categorias SET Id=NEW.Id,nombre=NEW.nombre,referencia=NEW.referencia WHERE Id=NEW.Id;
...
INSERT INTO punto_venta.pv_color SET Id=NEW.Id, nombre=NEW.nombre, referencia=NEW.referencia;
...
UPDATE punto_venta.pv_color SET  nombre=NEW.nombre, referencia=NEW.referencia WHERE Id=NEW.Id;
...
INSERT INTO punto_venta.pv_nombres SET Id=NEW.Id,nombre=NEW.nombre,referencia=NEW.referencia;
...
UPDATE punto_venta.pv_nombres SET nombre=NEW.nombre,referencia=NEW.referencia WHERE Id=NEW.Id;
...
INSERT INTO punto_venta.pv_producto SET nombre=NEW.nombre,categoria_id=NEW.categoria_id,unidad_id=NEW.unidad_id,codbarras=@codbarras,tipo_id=NEW.tipo_id,color_id=NEW.color_id,talla_id=NEW.talla_id;
END
;;
DELIMITER ;
...
UPDATE  punto_venta.pv_producto SET nombre=NEW.nombre,categoria_id=NEW.categoria_id,unidad_id=NEW.unidad_id,codbarras=@codbarras,tipo_id=NEW.tipo_id,color_id=NEW.color_id,talla_id=NEW.talla_id WHERE codbarras=OLD.codbarras;
...
UPDATE punto_venta.pv_producto SET estado_id='2' WHERE codbarras=OLD.codbarras;
...
INSERT INTO bodega.com_tallas SET Id=NEW.Id,talla=NEW.talla;

INSERT INTO punto_venta.pv_tallas SET Id=NEW.Id,talla=NEW.talla;
...
UPDATE bodega.com_tallas SET talla=NEW.talla where Id=NEW.Id;
UPDATE punto_venta.pv_tallas SET talla=NEW.talla where Id=NEW.Id;
...
INSERT INTO bodega.com_tipoproducto SET Id=NEW.Id,nombre=NEW.nombre, iteracion_id='2',cantubicaciones_id='1',referencia=NEW.referencia;
INSERT INTO punto_venta.pv_tipo SET Id=NEW.Id,nombre=NEW.nombre,referencia=NEW.referencia;
END
;;
DELIMITER ;
...
UPDATE bodega.com_tipoproducto SET nombre=NEW.nombre, iteracion_id='2',cantubicaciones_id='1',referencia=NEW.referencia WHERE Id=NEW.Id;
UPDATE punto_venta.pv_tipo SET Id=NEW.Id,nombre=NEW.nombre,referencia=NEW.referencia;
...
DELIMITER ;;
CREATE TRIGGER `trg_unidades` BEFORE INSERT ON `prov_unidades` FOR EACH ROW BEGIN

INSERT INTO bodega.com_unidades SET Id=NEW.Id,nombre=NEW.nombre;
INSERT INTO punto_venta.pv_unidades SET Id=NEW.Id,nombre=NEW.nombre;
...
DELIMITER ;;
CREATE TRIGGER `trg_unidades2` BEFORE UPDATE ON `prov_unidades` FOR EACH ROW BEGIN

UPDATE bodega.com_unidades SET nombre=NEW.nombre WHERE Id=NEW.Id;
UPDATE punto_venta.com_unidades SET nombre=NEW.nombre WHERE Id=NEW.Id;
