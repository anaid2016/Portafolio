<?php
	...
	$ds->SelectCommand = "SELECT * from prov_nombres ";
	$ds->UpdateCommand = "update prov_nombres set nombre='@nombre',referencia='@referencia' where Id=@Id";
	$ds->DeleteCommand = "delete from prov_nombres where nombre=@nombre";
	$ds->InsertCommand = "insert into prov_nombres (nombre,referencia) values ('@nombre','@referencia');";
