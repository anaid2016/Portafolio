<?php
	...
	$ds->SelectCommand = "SELECT * from prov_categorias ";
	$ds->UpdateCommand = "update prov_categorias set nombre='@nombre',referencia='@referencia' where Id=@Id";
	$ds->DeleteCommand = "delete from prov_categorias where nombre=@nombre";
	$ds->InsertCommand = "insert into prov_categorias (nombre,referencia) values ('@nombre','@referencia');";
