<?php
	...
	$ds->SelectCommand = "SELECT * from prov_color ";
	$ds->UpdateCommand = "update prov_color set nombre='@nombre',referencia='@referencia' where Id=@Id";
	$ds->DeleteCommand = "delete from prov_color where nombre=@nombre";
	$ds->InsertCommand = "insert into prov_color (nombre,referencia) values ('@nombre','@referencia');";
