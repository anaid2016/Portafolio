...
class VideosController extends Controller
{
     ...
     * @param int $id_videos Id Videos
     * @return string
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionView($id_videos)
    {
        return $this->render('view', [
            'model' => $this->findModel($id_videos),
        ]);
    }
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                return $this->redirect(['view', 'id_videos' => $model->id_videos]);
            }
        } else {
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($id_videos)
    {
        $model = $this->findModel($id_videos);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($id_videos)
    {
        $this->findModel($id_videos)->delete();
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id_videos)
    {
        if (($model = Videos::findOne(['id_videos' => $id_videos])) !== null) {
            return $model;
        }
